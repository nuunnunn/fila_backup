...
import {Button, Container, Nav, Navbar, Offcanvas, Col, Row, Table} from 'react-bootstrap';
  ...
  return (
    <div className="App">   
      ...
      <div style={{position:'relative'}}>
        <Navbar key='md' expand='md' className="bg-body-transparent mb-3" ref={nav}>
          <Container fluid>
            <Navbar.Brand href="/" className='logo' ref={logo}></Navbar.Brand>
            <Navbar.Toggle aria-controls={`offcanvasNavbar-expand-md`} onClick={clickHamburger}/>
            <Navbar.Offcanvas
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  ...
                  <div className='category_box'>
                    <Nav.Link href="#women" className='category' style={categories} onMouseOver={navMouseOn} onMouseOut={outNav}>WOMEN</Nav.Link>
                    <Nav.Link href="#men" className='category' style={categories} onMouseOver={navMouseOn} onMouseOut={outNav}>MEN</Nav.Link>
                    <Nav.Link href="#kids" className='category' style={categories} onMouseOver={navMouseOn} onMouseOut={outNav} >KIDS</Nav.Link>
                    <Nav.Link href="#kids" className='category' style={categories}>|</Nav.Link>
                    <Nav.Link href="#brand" className='category' style={categories} onMouseOver={navMouseOn} onMouseOut={outNav} >BRAND</Nav.Link>
                  </div>
        ...
        <div className='under_nav' style={showUnderNav}>
          ...
          <div className='opacity_block' onMouseOut={navMouseOut}></div>
        </div>
      </div>    
